"""
Django settings for match_service project.
...
CORS_ALLOWED_ORIGINS = [
    ...
    'http://localhost',
    'https://localhost',
    'https://frontend-danaremar.cloud.okteto.net'
]
...
ROOT_URLCONF = 'match_service.urls'
...
WSGI_APPLICATION = 'match_service.wsgi.application'
